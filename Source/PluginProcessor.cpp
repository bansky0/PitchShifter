...
juce::AudioProcessorValueTreeState::ParameterLayout PitchShifterAudioProcessor::createParameters()
{
    ...
    parameters.add(std::make_unique<juce::AudioParameterFloat>(juce::ParameterID{ "semitones", 1 }, "Semitones", -12.0f, 12.0f, 0.0f));
...
{
    float inSemitones = *apvts.getRawParameterValue("semitones");
